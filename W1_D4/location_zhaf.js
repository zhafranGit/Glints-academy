...
function getfromlatter(panjanghuruf) {
    let provincename = [];
    for (let regency of regencies) {
        if (regency.name.length == panjanghuruf) {
            provincename.push(regency.name)
        }
    }
    return provincename
}
console.log(getfromlatter(11));

//! mencari nama provenci dari kota
// function getProvinceByCitiyname(cityname) {
//     let provinceId
//     for (let regency of regencies) {
//         if (regency.name.includes(cityname.toUpperCase())) {
//             provinceId = regency.province_id
//         }
//     }
//     console.log(provinceId);
//     for (let provency of provinces) {
//         if (provency.id == provinceId) {
//             return provency.name;
//         }
//     }
//     return "Tidak DiTemukan";
// }
// console.log(getProvinceByCitiyname("aceh"));

// function getProvinciesControlNames(params) {
//     let hasil = []
//     for (let x of provinces) {
//         if (x.name.includes(params)) {
//             hasil.push(x.params)
//         }
//     }
//     return hasil
...
// console.log(getProvinciesControlNames("BARAT"));

// function getCitiesByProvinceNames(params) {
//     let provincesId = 0;
//     for (let y of regencies){
//         if (y.province_id == provincesId) {
//             hasil.push(y)
//         }
//     }
// }